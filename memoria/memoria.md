...
Y las relaciones entre los grupos se muestran en el siguiente diagrama

![Diagrama Roles](./diagramas/diagrama_roles.png)
...
| temperatura | Consideramos que son valores sospechosos para temperaturas en ciudades españolas los menores a -20ºC y mayores a 55ºC |
...
![Procesador Monitor](./imagenes/nifi-procesador-monitor.png)

De esta forma guardamos en el log cuando la actividad se interrumpe y cuando se reanuda.

Una vez finalizada esta parte, se obtiene el gráfico completo del prototipo implementado en Apache NiFi. Desde la captura de datos, su procesado, validación, unión, monitorización y guardado.

![Procesador Monitor](./imagenes/nifi-graficocompleto-con-calidad.png)
